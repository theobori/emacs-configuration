...
*** qBittorrent-transient

This Emacs package requires [[https://www.qbittorrent.org/][qBittorrent]].

#+begin_src emacs-lisp
(use-package qbittorrent-transient
  :straight (qbittorrent-transient :type git :host github :repo "theobori/qbittorrent-transient"))
#+end_src
